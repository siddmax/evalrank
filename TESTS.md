...
- `tests/test_repo_docs.py` checks `CLAUDE.md` stays a one-line `@AGENTS.md` shim and `docs/REPO_STRUCTURE.md` tracks the public top-level directories and package directories exactly.
