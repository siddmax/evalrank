...
- `tests/test_decision_contracts.py` checks immutable source/run provenance, the five native observation metric kinds, explicit uncertainty, resolved configuration passports, serving-offer fact separation, reviewed offer links, semantic query normalization, and deterministic full-body receipt identities.
