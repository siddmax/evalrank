...
Use `evalrank_core.fixtures.sample_capability_fingerprint_input()`, `sample_evaluation_request()`, `sample_recommendation()`, and `sample_evidence_item()` for public examples and contract tests.
