...
- Public TypeScript interfaces for `CapabilityFingerprint`, `RawEntry`, `TheCall`, `ProblemDetails`, `EntityRef`, `EvaluationRequest`, `CandidateSet`, `StageCandidate`, `EvidenceSet`, `Exclusion`, `EvidenceItem`, `ResultRow`, `UseCase`, `UseCaseCatalog`, `RankedEntity`, and `Recommendation`.
