...
- `RunInputArtifactV1` gives every retained parser input a stable role; `RunProvenanceV1.source_artifacts` is sorted, unique, non-empty, and contains exactly one `primary`.
