...
2. Candidate resolution: identify a public `CandidateSet` of `EntityRef` rows that can be evaluated for the request; excluded candidates surface as public `Exclusion` rows with reasons.
