...
| Python SDK | Package metadata and public re-exports from `evalrank_core`, including public vocabulary constants and public fixture dispatch helpers. | Installed package release flow and non-fixture client behavior. |
