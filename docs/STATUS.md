...
- Public Contracts workstream: pin the next storage-free payload contract before adding more SDK/CLI/MCP behavior; after `the_call`, the next likely candidate is a public route/OpenAPI contract only when a concrete route exists.
