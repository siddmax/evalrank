...
Keep MCP metadata tools as a separate SDK / CLI / MCP follow-up slice. Runtime persistence and hosted operation are maintained in a separate private system. Keep live hosted implementations, persistence bootstrap, runtime migrations, runtime scorer/materializer behavior, graph/evidence lookup, and eval-integrity material in their private owning workstreams until each has a separable public contract.
