...
Keep TypeScript metadata helpers, CLI metadata commands, and MCP metadata tools as separate SDK / CLI / MCP follow-up slices. Runtime persistence and hosted operation are maintained in a separate private system; keep live hosted implementations, persistence bootstrap, versioned migrations, runtime scorer/materializer behavior, graph/evidence lookup, and eval-integrity material in their private owning workstreams until each has a separable public contract.
