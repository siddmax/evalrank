...
- Reported progress against the full private EvalRank spec and W0-W9 implementation model without copying private source text.
...
- Private spec docs, raw private build plans, live project identifiers, customer data, held-out evals, traces, runbooks, and operational details were not copied into this repo.
...
- Syndai/private workstreams remain the owner of DB bootstrap, source adapters, evidence graph, scorer/materializer runtime, hosted services, telemetry, GTM, and evaluation-integrity material until a separable public contract exists.
