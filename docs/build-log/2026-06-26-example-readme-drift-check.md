...
- No private Syndai/Finn/Savida code, customer data, production telemetry, held-out eval material, hosted auth, persistence, source adapter, scorer runtime, or deploy wiring was added.

## Porting Decision

- README drift guards belong in this public repo because they prevent public contract skew.
- Runtime scorer/materializer code, graph lookup, source adapters, DB migrations, hosted receipts, auth, and eval-integrity material stay private until a separate public cutover is explicitly designed.
